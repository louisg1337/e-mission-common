...
export var get_egrid_intensity_for_region = async function (year, region, metadata) {
	...
	Logger.log_debug ('Getting eGRID carbon intensity for year {} and region {}'.format (year, region));
	...
	if (region !== null && __in__ (region, intensities_data ['regions_kg_per_mwh'])) {
		...
		Logger.log_warn ('eGRID region not found for region {} in year {}. Using national average.'.format (region, year));
