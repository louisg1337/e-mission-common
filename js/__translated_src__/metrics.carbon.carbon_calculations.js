...
export var get_carbon_mode_map = memoize (function (label_options) {
...
export var highest_carbon_mode = memoize (function (label_options) {
...
export var carbon_summary_by_mode = memoize (function (composite_trips, label_options) {
